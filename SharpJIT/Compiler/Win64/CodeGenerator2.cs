...
namespace SharpJIT.Compiler.Win64
{
    ...
    public class CodeGenerator2 : InstructionPass<CompilationData>
    {
        ...
        public CodeGenerator2(VirtualMachine virtualMachine)
        {
        ...
        {
            compilationData.Assembler.Multiply(ExtendedRegister.R10, TypeSystem.SizeOf(elementType));
            compilationData.Assembler.Add(Register.AX, ExtendedRegister.R10);
        ...
        protected override void HandleLoadElement(CompilationData compilationData, Instruction instruction, int index)
        {
            ...
            //Pop the operands
            compilationData.OperandStack.PopRegister(ExtendedRegister.R10); //The index of the element
